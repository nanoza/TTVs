...
def jump_times_lc_jupyter(input_id, flux_type, mission_select, input_planet_number, input_dir, input_depth=0.02,
    input_period=None, input_t0=None, input_duration=None, input_mask_width=1.3, input_show_plots=True, input_dont_bin=False):
